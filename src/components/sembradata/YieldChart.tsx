...
export const YieldChart = memo(function YieldChart({ crop, factor, viabilityScore = 50 }: Props) {
  ...
  const data = [
    ...
    { year: "2024", hist: base * 0.98, pred: base * (0.98 + scoreAdjustment * 0.1) },
    { year: "2025", hist: null, pred: base * (1.02 + scoreAdjustment * 0.15) },
    { year: "2026", hist: null, pred: base * (1.08 + scoreAdjustment * 0.2) },
    { year: "2027", hist: null, pred: base * (1.12 + scoreAdjustment * 0.25) },
  ];
