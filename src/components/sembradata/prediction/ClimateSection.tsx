  ...
  return (
    <Card className="rounded-2xl">
      <CardHeader className="pb-3">
        <CardTitle className="text-sm font-semibold">Condiciones Climáticas</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-2">
          ...
          <ClimateMetric
            label="Precipitación"
            value={`${climate.precipitation.toFixed(1)} mm`}
            detail="Actual"
          />
          <ClimateMetric
            label="Viento"
        ...
        {climate.dailyData.length > 0 && (
          <div>
            ...
            <div className="flex gap-1.5 overflow-x-auto pb-1">
              {climate.dailyData.slice(0, 7).map((d, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <p className="text-[9px] text-muted-foreground">{d.tempMin.toFixed(0)}°</p>
                  <p className="mt-0.5 text-[8px] text-sky-600">
